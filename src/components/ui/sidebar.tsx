		...
		>
			...
			<div
				className={cn(
					...
					variant === 'floating' || variant === 'inset'
						? 'p-[14px] group-data-[collapsible=icon]:w-[calc(var(--sidebar-width-icon)+(--spacing(4))+2px)]'
