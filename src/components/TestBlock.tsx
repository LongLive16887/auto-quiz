	...
	return (
		<Dialog open={open} onOpenChange={setOpen}>
			<DialogTrigger asChild>
				<div className='flex flex-col relative bg-white/10 backdrop-blur-lg items-center py-10 cursor-pointer gap-2 max-w-[150px] w-full rounded-lg border hover:shadow-sm transition'>
